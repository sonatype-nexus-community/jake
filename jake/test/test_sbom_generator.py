...
class TestSbomGenerator(unittest.TestCase):
  ...
  def test_can_create_valid_root_element(self):
    ...
    self.assertEqual(item.__getitem__(14).__getitem__(0).text, "ncurses")
    self.assertEqual(item.__getitem__(14).__getitem__(1).text, "6.1")
    self.assertEqual(item.__getitem__(14).__getitem__(2).text, "pkg:conda/ncurses@6.1")
